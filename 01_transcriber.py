...
if __name__ == "__main__":
    files = [
        ("usct_pension_files/A_B/Ammerman Joseph.pdf", None),
        ("usct_pension_files/A_B/Artis_Joseph_pension file_mother.pdf", None),
        ("usct_pension_files/A_B/Ashbrook Noah.pdf", None),
        ("usct_pension_files/A_B/Bias James.pdf", None),
        ("usct_pension_files/A_B/Billups Peter Civil War Pension.pdf", None),
        ("usct_pension_files/A_B/Blake Isaac Civil War Pension.pdf", None),
        ("usct_pension_files/A_B/Booker John.pdf", None),
        ("usct_pension_files/A_B/Bray Thomas Civil War Pension.pdf", None),
        ("usct_pension_files/C_D/Carneyhan Harvey.pdf", None),
        ("usct_pension_files/C_D/Chambers Aaron.pdf", None),
        ("usct_pension_files/C_D/Chase Charles Civil War Pension.pdf", None),
        ("usct_pension_files/C_D/Clay Henry.pdf", None),
        ("usct_pension_files/C_D/Crosthwait George (1)-compressed.pdf", None),
        ("usct_pension_files/G_H/Holmes Luke Civil War Pension.pdf", None),
        ("usct_pension_files/M_N/Armstead Mann.pdf", None),
        ("usct_pension_files/M_N/Midgett Fields Civil War Pension.pdf", None),
        ("usct_pension_files/S_T/Stowers Samuel Jr.pdf", None),
    ]
